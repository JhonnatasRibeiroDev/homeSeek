...
import { Building2, Filter, MessageCircle, Phone, ArrowLeft } from 'lucide-react';
...
const UnitsDetailPage: React.FC = () => {
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl font-bold text-gray-900 flex items-center">
              ...
              Unidades Disponíveis - {property.title}
            </h1>
          </div>
        </div>
      </div>
        ...
        <div className="bg-gray-50 p-4 rounded-lg sticky top-0 z-10">
          ...
          <div className="grid grid-cols-6 gap-4">
            <div>
              ...
              <Select value={filters.tower} onValueChange={(value) => setFilters(prev => ({ ...prev, tower: value === 'all' ? '' : value }))}>
            ...
            <div>
              ...
              <Select value={filters.floor} onValueChange={(value) => setFilters(prev => ({ ...prev, floor: value === 'all' ? '' : value }))}>
                <SelectTrigger className="h-8">
            ...
            <div>
              ...
              <Select value={filters.typology} onValueChange={(value) => setFilters(prev => ({ ...prev, typology: value === 'all' ? '' : value }))}>
                <SelectTrigger className="h-8">
                  <SelectValue placeholder="Todas" />
                </SelectTrigger>
                <SelectContent>
...
export default UnitsDetailPage;
